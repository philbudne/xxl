...
#### `as_class (this, klass)`
*PyFunc at classes.py:967 (obj_as_class)*
...
#### `props (this)`
*PyFunc at classes.py:752 (obj_props)*

> returns an Iterable for (String) property names of `this` Object

</font>
#### `repr (this)`
*PyFunc at classes.py:1887 (bool_str)*

> return Str representation: &quot;true&quot; or &quot;false&quot;

<font color="slategray">
#### `reprx (this)`
*PyFunc at classes.py:1148 (pobj_reprx)*

> for debug: show Class name, and Python repr

</font><font color="slategray">
#### `setclass (this, klass)`
*PyFunc at classes.py:960 (obj_setclass)*

> set Class for `this`!!

</font><font color="slategray">
#### `setprop (l, r, value)`
*PyFunc at classes.py:814 (obj_setprop)*
...
<font color="slategray">
#### `! (x)`
*PyFunc at classes.py:797 (obj_not)*
...
<font color="slategray">
#### `!= (l, r)`
*PyFunc at classes.py:1182 (pobj_differ)*
...
#### `( (this_class, ...args)`
*PyFunc at classes.py:1072 (class_call)*
...
#### `.. (this, prop)`
*PyFunc at classes.py:942 (obj_get_in_supers)*
...
#### `== (l, r)`
*PyFunc at classes.py:1171 (pobj_ident)*
...
*PyFunc at classes.py:1032 (class_create)*
...
*PyFunc at classes.py:1040 (class_init)*
...
#### `repr (this)`
*PyFunc at classes.py:760 (obj_repr)*

> Default Object string representation method (calls Python repr(this))

</font><font color="slategray">
#### `reprx (l)`
*PyFunc at classes.py:768 (obj_reprx)*
...
#### `subclass_of (this, c)`
*PyFunc at classes.py:1082 (class_subclass_of)*
...
<font color="slategray">
#### `!= (l, r)`
*PyFunc at classes.py:782 (obj_differ)*
...
#### `== (l, r)`
*PyFunc at classes.py:775 (obj_ident)*
...
#### `init (this_obj, ...args)`
*PyFunc at classes.py:734 (obj_init)*
...
#### `items (this)`
*PyFunc at classes.py:1361 (dict_items)*

> Return PyIterable for [key, value] value pairs.

<font color="slategray">
#### `iter (this)`
*PyFunc at classes.py:1270 (pyiterable_iter)*

> Return forward iterator.

</font>
#### `keys (this)`
*PyFunc at classes.py:1368 (dict_keys)*

> Return PyIterable for Dict keys.

#### `len (this)`
*PyFunc at classes.py:1125 (pobj_len)*
...
#### `pop (obj, key)`
*PyFunc at classes.py:1354 (dict_pop)*
...
#### `range (...args)`
*PyFunc at classes.py:1301 (pyiterable_range)*
...
#### `reversed (this)`
*PyFunc at classes.py:1277 (pyiterable_reversed)*
...
#### `sorted (this, reverse)`
*PyFunc at classes.py:1286 (pyiterable_sorted)*
...
#### `values (this)`
*PyFunc at classes.py:1375 (dict_values)*
...
#### `[ (l, r)`
*PyFunc at classes.py:1336 (dict_get)*
...
#### `[ (l, r, value)`
*PyFunc at classes.py:1327 (dict_put)*
...
#### `append (this, item)`
*PyFunc at classes.py:1408 (list_append)*
...
#### `pop (l, index)`
*PyFunc at classes.py:1416 (list_pop)*
...
#### `[ (l, r)`
*PyFunc at classes.py:1425 (list_get)*
...
#### `[ (l, r, value)`
*PyFunc at classes.py:1433 (list_put)*
...
*PyFunc at classes.py:2163 (modinfo_assemble)*
...
#### `load_vmx (this, fname)`
*PyFunc at classes.py:2153 (modinfo_load_vmx)*
...
#### `getprop (l, r)`
*PyFunc at classes.py:1848 (nullish_getprop)*
...
#### `repr (this)`
*PyFunc at classes.py:1824 (null_str)*
...
#### `setprop (l, r, value)`
*PyFunc at classes.py:1866 (nullish_setprop)*
...
#### `( (this, ...args)`
*PyFunc at classes.py:1831 (null_call)*
...
#### `( (l, ...args)`
*PyFunc at classes.py:978 (obj_call)*
...
#### `repr (this)`
*PyFunc at classes.py:1140 (pobj_repr)*
...
#### `- (x)`
*PyFunc at classes.py:1462 (neg)*

> Return negative of `x`

#### `~ (this)`
*PyFunc at classes.py:1598 (bitnot)*
...
#### `&amp; (l, r)`
*PyFunc at classes.py:1572 (bitand)*
...
#### `* (l, r)`
*PyFunc at classes.py:1493 (mul)*

> multiply `l` and `r`

#### `+ (l, r)`
*PyFunc at classes.py:1469 (add)*

> add `l` and `r`

#### `- (l, r)`
*PyFunc at classes.py:1482 (sub)*
...
#### `/ (l, r)`
*PyFunc at classes.py:1506 (div)*

> Divide `l` by `r`; always creates float.

#### `&lt; (l, r)`
*PyFunc at classes.py:1548 (lt)*

> return `true` if value of `l` is &lt; the value of `r`

#### `&lt;= (l, r)`
*PyFunc at classes.py:1558 (le)*

> return `true` if value of `l` is &lt;= the value of `r`

#### `== (l, r)`
*PyFunc at classes.py:1524 (eq)*
...
#### `&gt; (l, r)`
*PyFunc at classes.py:1565 (gt)*

> return `true` if value of `l` is &gt; the value of `r`

#### `&gt;= (l, r)`
*PyFunc at classes.py:1541 (ge)*

> return `true` if value of `l` is &gt;= the value of `r`

#### `| (l, r)`
*PyFunc at classes.py:1585 (bitor)*
...
#### `create (this_class)`
*PyFunc at classes.py:1110 (pclass_create)*
...
#### `iter (this)`
*PyFunc at classes.py:1993 (pyiterator_iter)*
...
*PyFunc at classes.py:2003 (pyiterator_next)*
...
#### `props (this)`
*PyFunc at classes.py:1956 (pyobj_props)*
...
#### `( (this, ...args)`
*PyFunc at classes.py:1971 (pyobj_call)*

> 

#### `. (l, r)`
*PyFunc at classes.py:1939 (pyobj_getprop)*
...
#### `[ (l, r)`
*PyFunc at classes.py:1963 (pyobj_getitem)*
...
#### `chr (i)`
*PyFunc at classes.py:1787 (str_chr)*
...
#### `ends_with (this, suff)`
*PyFunc at classes.py:1711 (str_ends_with)*
...
#### `ord (this)`
*PyFunc at classes.py:1729 (str_ord)*
...
*PyFunc at classes.py:1682 (str_slice)*
...
*PyFunc at classes.py:1697 (str_split)*
...
*PyFunc at classes.py:1736 (str_starts_with)*

> Return `true` if `this` starts with prefix `pref, `false` otherwise.

#### `strip (this)`
*PyFunc at classes.py:1750 (str_strip)*

> Return a copy of the string with leading and trailing whitespace removed.

#### `to_float (this)`
*PyFunc at classes.py:1757 (str_to_float)*

> Convert string to a floating point Number

#### `to_int (this, base)`
*PyFunc at classes.py:1764 (str_to_int)*

> Convert string to integer Number. Int `base` defaults to zero (accept 0xXXX, 0oOOO, 0bBBB).

#### `to_number (this)`
*PyFunc at classes.py:1776 (str_to_number)*

> Convert string to a Number

#### `to_str (this)`
*PyFunc at classes.py:1743 (str_str)*
...
#### `+ (x, y)`
*PyFunc at classes.py:1660 (str_concat)*
...
#### `[ (l, r)`
*PyFunc at classes.py:1673 (str_get)*
...
#### `repr (this)`
*PyFunc at classes.py:2026 (undef_str)*
...
#### `( (this, ...args)`
*PyFunc at classes.py:2033 (undef_call)*
