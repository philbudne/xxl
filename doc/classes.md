...
#### `! (x)`
*PyFunc at classes.py:783 (obj_not)*
...
#### `!= (l, r)`
*PyFunc at classes.py:1135 (pobj_differ)*
...
#### `( (this_class, ...args)`
*PyFunc at classes.py:1027 (class_call)*
...
*PyFunc at classes.py:712 (obj_create)*
...
*PyFunc at classes.py:996 (class_init)*
...
#### `repr (this)`
*PyFunc at classes.py:746 (obj_repr)*

> Default Object string representation method (calls Python repr(this))

#### `reprx (l)`
*PyFunc at classes.py:754 (obj_reprx)*
...
#### `subclass_of (this, c)`
*PyFunc at classes.py:1036 (class_subclass_of)*
...
#### `!= (l, r)`
*PyFunc at classes.py:768 (obj_differ)*
...
#### `== (l, r)`
*PyFunc at classes.py:761 (obj_ident)*
...
#### `init (this_obj, ...args)`
*PyFunc at classes.py:720 (obj_init)*
...
#### `items (this)`
*PyFunc at classes.py:1314 (dict_items)*

> Return PyIterable for [key, value] value pairs.

#### `iter (this)`
*PyFunc at classes.py:1223 (pyiterable_iter)*

> Return forward iterator.

#### `keys (this)`
*PyFunc at classes.py:1321 (dict_keys)*

> Return PyIterable for Dict keys.

#### `len (this)`
*PyFunc at classes.py:1078 (pobj_len)*
...
#### `pop (obj, key)`
*PyFunc at classes.py:1307 (dict_pop)*
...
#### `range (...args)`
*PyFunc at classes.py:1254 (pyiterable_range)*
...
#### `reversed (this)`
*PyFunc at classes.py:1230 (pyiterable_reversed)*
...
#### `sorted (this, reverse)`
*PyFunc at classes.py:1239 (pyiterable_sorted)*
...
#### `values (this)`
*PyFunc at classes.py:1328 (dict_values)*
...
#### `[ (l, r)`
*PyFunc at classes.py:1289 (dict_get)*
...
#### `[ (l, r, value)`
*PyFunc at classes.py:1280 (dict_put)*
...
#### `append (this, item)`
*PyFunc at classes.py:1361 (list_append)*
...
#### `pop (l, index)`
*PyFunc at classes.py:1369 (list_pop)*
...
#### `[ (l, r)`
*PyFunc at classes.py:1378 (list_get)*
...
#### `[ (l, r, value)`
*PyFunc at classes.py:1386 (list_put)*
...
*PyFunc at classes.py:2062 (modinfo_assemble)*
...
#### `load_vmx (this, fname)`
*PyFunc at classes.py:2052 (modinfo_load_vmx)*
...
#### `repr (this)`
*PyFunc at classes.py:1780 (null_str)*
...
#### `( (this, ...args)`
*PyFunc at classes.py:1787 (null_call)*
...
#### `repr (this)`
*PyFunc at classes.py:1093 (pobj_repr)*
...
#### `- (x)`
*PyFunc at classes.py:1415 (neg)*

> Return negative of `x`

#### `~ (this)`
*PyFunc at classes.py:1551 (bitnot)*
...
#### `& (l, r)`
*PyFunc at classes.py:1525 (bitand)*

> return bitwise (binary) "and" (conjunction) of `l` and `r`

#### `( (l, ...args)`
*PyFunc at classes.py:945 (obj_call)*

> default Object `(` binop (fatal error)

#### `* (l, r)`
*PyFunc at classes.py:1446 (mul)*

> multiply `l` and `r`

#### `+ (l, r)`
*PyFunc at classes.py:1422 (add)*

> add `l` and `r`

#### `- (l, r)`
*PyFunc at classes.py:1435 (sub)*
...
#### `/ (l, r)`
*PyFunc at classes.py:1459 (div)*

> Divide `l` by `r`; always creates float.

#### `< (l, r)`
*PyFunc at classes.py:1501 (lt)*

> return `true` if value of `l` is < the value of `r`

#### `<= (l, r)`
*PyFunc at classes.py:1511 (le)*

> return `true` if value of `l` is <= the value of `r`

#### `== (l, r)`
*PyFunc at classes.py:1477 (eq)*
...
#### `> (l, r)`
*PyFunc at classes.py:1518 (gt)*

> return `true` if value of `l` is > the value of `r`

#### `>= (l, r)`
*PyFunc at classes.py:1494 (ge)*

> return `true` if value of `l` is >= the value of `r`

#### `| (l, r)`
*PyFunc at classes.py:1538 (bitor)*
...
#### `create (this_class)`
*PyFunc at classes.py:1063 (pclass_create)*
...
#### `iter (this)`
*PyFunc at classes.py:1911 (pyiterator_iter)*
...
*PyFunc at classes.py:1921 (pyiterator_next)*
...
#### `props (this)`
*PyFunc at classes.py:1874 (pyobj_props)*
...
#### `( (this, ...args)`
*PyFunc at classes.py:1889 (pyobj_call)*

> 

#### `. (l, r)`
*PyFunc at classes.py:1857 (pyobj_getprop)*
...
#### `[ (l, r)`
*PyFunc at classes.py:1881 (pyobj_getitem)*
...
#### `chr (i)`
*PyFunc at classes.py:1743 (str_chr)*
...
#### `ends_with (this, suff)`
*PyFunc at classes.py:1664 (str_ends_with)*
...
#### `ord (this)`
*PyFunc at classes.py:1682 (str_ord)*
...
*PyFunc at classes.py:1635 (str_slice)*
...
*PyFunc at classes.py:1650 (str_split)*
...
*PyFunc at classes.py:1692 (str_starts_with)*

> Return `true` if `this` starts with prefix `pref, `false` otherwise.

#### `strip (this)`
*PyFunc at classes.py:1706 (str_strip)*

> Return a copy of the string with leading and trailing whitespace removed.

#### `to_float (this)`
*PyFunc at classes.py:1713 (str_to_float)*

> Convert string to a floating point Number

#### `to_int (this, base)`
*PyFunc at classes.py:1720 (str_to_int)*

> Convert string to integer Number `base` defaults to zero (accept 0xXXX for base 16)

#### `to_number (this)`
*PyFunc at classes.py:1732 (str_to_number)*

> Convert string to a Number

#### `to_str (this)`
*PyFunc at classes.py:1699 (str_str)*
...
#### `+ (x, y)`
*PyFunc at classes.py:1613 (str_concat)*
...
#### `[ (l, r)`
*PyFunc at classes.py:1626 (str_get)*
...
---
formatted by doc.xxl on 2021-06-21
